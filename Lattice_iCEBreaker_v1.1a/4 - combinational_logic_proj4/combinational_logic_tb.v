...
module combinational_logic_tb;
    ...
    initial begin
        ...
        $display("Time | S7 S8 | OUT1 OUT2 OUT3 OUT4 OUT5");
        $monitor("%2t |  %b  %b |   %b    %b    %b    %b    %b",
                 $time, tb_S7, tb_S8, tb_OUT1, tb_OUT2, tb_OUT3, tb_OUT4, tb_OUT5);
        
        // Test OUT1 function.. NOT S7
        tb_S8 = 0;
        tb_S7 = 0;
        #10;
        tb_S7 = 1;
